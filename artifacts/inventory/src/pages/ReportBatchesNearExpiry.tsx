  ...
  return (
    <div className="space-y-6 max-w-6xl">
      <PageHeader
        ...
        backHref="/reports"
        breadcrumbs={[{ label: "Reports", href: "/reports" }, { label: "Batches Near Expiry" }]}
        actions={
          <ReportExportButton
      ...
      <TablePagination total={total} page={page} pageSize={pageSize} onPageChange={setPage} pageSizeOptions={PAGE_SIZE_OPTIONS} onPageSizeChange={setPageSize} />
    </div>
  );
}
