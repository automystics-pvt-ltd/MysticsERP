...
export default function ReportSalesSummary() {
  ...
  return (
    <div className="space-y-6 max-w-6xl">
          ...
          <Table>
            ...
            <TableBody>
              {report.byCustomer.length === 0 ? (
                ...
                report.byCustomer.slice((page - 1) * pageSize, page * pageSize).map((row) => (
      ...
      <TablePagination total={report.byCustomer.length} page={page} pageSize={pageSize} onPageChange={setPage} itemLabel="customers" pageSizeOptions={PAGE_SIZE_OPTIONS} onPageSizeChange={setPageSize} />
    </div>
  );
}
