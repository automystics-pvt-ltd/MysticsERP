...
type StatusType = "draft" | "confirmed" | "ordered" | "shipped" | "partially_shipped" | "partially_received" | "delivered" | "cancelled" | "refunded" | "received" | "billed" | "paid" | "active" | "inactive" | "pending" | "pending_approval" | "returned" | "invoiced";
...
export function StatusBadge({ status, className }: StatusBadgeProps) {
  ...
  switch (normalizedStatus) {
    ...
    case "pending_approval":
      variant = "secondary";
      colorClass = "bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400 hover:bg-amber-100 dark:hover:bg-amber-900/30 border-amber-200 dark:border-amber-800/30";
      break;
  ...
  return (
    <Badge 
      variant={variant} 
      className={cn("capitalize text-[11px] font-semibold tracking-wide", colorClass, className)}
