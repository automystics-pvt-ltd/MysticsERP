...
export function serializeOrganization(o: Organization) {
  return {
    ...
    showMaxDiscountAmount:
      (o as unknown as { showMaxDiscountAmount?: boolean | null }).showMaxDiscountAmount ?? true,
    showMaxDiscountPercent:
      (o as unknown as { showMaxDiscountPercent?: boolean | null }).showMaxDiscountPercent ?? true,
    showOrderDiscount:
      (o as unknown as { showOrderDiscount?: boolean | null }).showOrderDiscount ?? true,
    skuMode:
      (o as unknown as { skuMode?: string | null }).skuMode ?? "manual",
    skuPrefix:
      (o as unknown as { skuPrefix?: string | null }).skuPrefix ?? null,
    skuFormat:
      (o as unknown as { skuFormat?: string | null }).skuFormat ?? "digits",
    skuNextNumber:
  ...
  return {
    ...
    maxDiscountAmount:
      (i as unknown as { maxDiscountAmount?: string | null }).maxDiscountAmount != null
        ...
        : null,
    brand: (i as unknown as { brand?: string | null }).brand ?? null,
    weight:
      (i as unknown as { weight?: string | null }).weight != null
        ? toNum((i as unknown as { weight: string }).weight)
        : null,
    weightUnit: (i as unknown as { weightUnit?: string | null }).weightUnit ?? "g",
    dimensionLength:
      (i as unknown as { dimensionLength?: string | null }).dimensionLength != null
        ? toNum((i as unknown as { dimensionLength: string }).dimensionLength)
        : null,
    dimensionWidth:
      (i as unknown as { dimensionWidth?: string | null }).dimensionWidth != null
        ? toNum((i as unknown as { dimensionWidth: string }).dimensionWidth)
        : null,
    dimensionHeight:
      (i as unknown as { dimensionHeight?: string | null }).dimensionHeight != null
...
export function serializeStockMovement(
  ...
  return {
    ...
    itemUnitCost: itemUnitCost !== null ? toNum(itemUnitCost) : null,
