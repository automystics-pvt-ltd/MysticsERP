...
export const ListItemsResponseItem = zod.object({
  ...
  "maxDiscountAmount": zod.number().nullable(),
  "weight": zod.number().nullable(),
  "weightUnit": zod.string(),
  "dimensionLength": zod.number().nullable(),
...
export const CreateItemBody = zod.object({
  ...
  "maxDiscountPercent": zod.number().nullish().describe('Max discount % cap (0–100). Null means no cap.'),
  "maxDiscountAmount": zod.number().nullish().describe('Max flat discount cap in rupees. Null means no cap.'),
  "weight": zod.number().nullish(),
  "weightUnit": zod.string().optional(),
  "dimensionLength": zod.number().nullish(),
  "dimensionWidth": zod.number().nullish(),
  "dimensionHeight": zod.number().nullish(),
...
export const ListStockMovementsResponseItem = zod.object({
  ...
  "quantity": zod.number(),
  "itemUnitCost": zod.number().nullable(),
...
export const ListSuppliersResponse = zod.object({
  ...
  "overduePayablesCount": zod.number(),
  "overduePayablesAmount": zod.string(),
  "page": zod.number(),
  "pageSize": zod.number()
})
...
export const GetDashboardSummaryResponse = zod.object({
  ...
  "lowStockCountPrevPeriod": zod.number().describe('Reconstructed low-stock item count as of the end of the prior comparison period'),
  "openSalesOrders": zod.number(),
  "openPurchaseOrders": zod.number(),
  "newSalesOrdersThisPeriod": zod.number().describe('Non-cancelled SOs with orderDate in the selected period'),
  "newSalesOrdersPrevPeriod": zod.number().describe('Non-cancelled SOs with orderDate in the prior comparison period'),
  "salesThisMonth": zod.number(),
  "salesPrevPeriod": zod.number(),
  "purchasesThisMonth": zod.number(),
  "purchasesPrevPeriod": zod.number(),
  "outstandingReceivables": zod.number(),
  "overdueReceivables": zod.number(),
  "outstandingPayables": zod.number(),
  "overduePayables": zod.number(),
  "receivablesPrevPeriod": zod.number(),
  "payablesPrevPeriod": zod.number(),
  "prevFromISO": zod.string().describe('ISO date (YYYY-MM-DD) of the start of the comparison period'),
  "prevToISO": zod.string().describe('ISO date (YYYY-MM-DD) of the end of the comparison period'),
...
export const GetPurchaseSummaryReportResponse = zod.object({
  ...
  "orderCount": zod.number(),
  "averageOrderValue": zod.number(),
  "months": zod.array(zod.string()).describe('Ordered list of YYYY-MM month keys present in the result'),
...
export const GetStockTransfersReportQueryParams = zod.object({
  "from": zod.coerce.string().optional(),
  "to": zod.coerce.string().optional(),
  "warehouseId": zod.coerce.number().optional()
})

export const GetStockTransfersReportResponse = zod.object({
  "totalTransfers": zod.number(),
  "completedTransfers": zod.number(),
  "inTransitTransfers": zod.number(),
  "draftTransfers": zod.number(),
  "cancelledTransfers": zod.number(),
...
export const GetPosSessionsReportQueryParams = zod.object({
  "from": zod.coerce.string().optional(),
  "to": zod.coerce.string().optional(),
  "warehouseId": zod.coerce.number().optional()
})

export const GetPosSessionsReportResponse = zod.object({
  "totalSessions": zod.number(),
  "openSessions": zod.number(),
  "closedSessions": zod.number(),
  "totalSales": zod.number(),
  "avgSalesPerSession": zod.number(),
...
export const GetShopifyOrdersReportQueryParams = zod.object({
  "from": zod.coerce.string().optional(),
  "to": zod.coerce.string().optional(),
  "warehouseId": zod.coerce.number().optional()
})

export const GetShopifyOrdersReportResponse = zod.object({
...
export const GetInventoryAgeingReportQueryParams = zod.object({
  "warehouseId": zod.coerce.number().optional()
})

export const GetInventoryAgeingReportResponse = zod.object({
...
export const ListJobWorkOrdersResponse = zod.object({
  "orders": zod.array(zod.object({
  "id": zod.number(),
...
export const PosCheckoutBody = zod.object({
  ...
  "sessionId": zod.number().nullish().describe('Active POS session ID. Links the sale to the session for accurate per-session reconciliation.')
})
