...
export interface PurchaseMonthlyBreakdown {
  /** YYYY-MM */
  month: string;
  total: number;
}

export interface PurchaseTopItem {
  itemId: number;
  itemName: string;
  sku: string;
  orderCount: number;
...
export interface ProfitLossReportTrendPoint {
  date: string;
  revenue: number;
  cogs: number;
  grossProfit: number;
...
export interface ShopifyOrdersTrendPoint {
  date: string;
  revenue: number;
  count: number;
}
...
export interface InventoryAgeingSummaryRow {
  bucket: string;
  itemCount: number;
  stockValue: number;
  totalUnits: number;
...
export interface PosCheckoutBody {
  ...
  /**
     * Active POS session ID. Links the sale to the session for accurate per-session reconciliation.
     * @nullable
     */
...
export type GetStockTransfersReportParams = {
from?: string;
to?: string;
warehouseId?: number;
};
...
export type GetPosSessionsReportParams = {
from?: string;
to?: string;
warehouseId?: number;
};

export type GetShopifyOrdersReportParams = {
from?: string;
to?: string;
warehouseId?: number;
};

export type GetInventoryAgeingReportParams = {
warehouseId?: number;
};
